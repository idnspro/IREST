...
/*
|--------------------------------------------------------------------------
| Frontend restaurant listing page
|--------------------------------------------------------------------------
|
| It is restaurant listing page
|
*/
...
// Search form submmision : Start here
...
if ( ! empty( $_REQUEST['destinations'] ) ) { $destinations = form_text('destinations'); $destinations = stripslashes( $destinations ); }
if ( ! empty( $destinations ) ) {
	...
	if ( ! empty( $destinationArr['country_id'] ) && 0 !== $destinationArr['country_id'] ) { $country_id = $destinationArr['country_id']; $country_id = stripslashes( $country_id );}
	if ( ! empty( $destinationArr['state_id'] ) && 0 !== $destinationArr['state_id'] ) { $state_id = $destinationArr['state_id']; $state_id = stripslashes( $state_id );}
	if ( ! empty( $destinationArr['city_id'] ) && 0 !== $destinationArr['city_id'] ) { $city_id = $destinationArr['city_id']; $city_id = stripslashes( $city_id );}
