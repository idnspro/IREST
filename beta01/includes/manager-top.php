...
$managerRestaurantArr = $restObj->fun_getManagerRestaurantArr($user_id);
if(is_array($managerRestaurantArr)&&(count($managerRestaurantArr) > 0)){
    $total_restaurants = count($managerRestaurantArr);
} else {
    $total_restaurants = 0;
}
