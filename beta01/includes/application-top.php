...
if(checkMobile() == true) {
	...
	if((strpos($str_url, "/mobile/") == false) && (!isset($_SESSION['os_mobile']) || ($_SESSION['os_mobile'] != '1'))) {
...
$twitterlink 	= ($siteInfoArr[1] != "")?$siteInfoArr[1]:"http://www.twitter.com";
$facebooklink 	= ($siteInfoArr[2] != "")?$siteInfoArr[2]:"http://www.facebook.com";
$youtubelink 	= ($siteInfoArr[3] != "")?$siteInfoArr[3]:"http://www.youtube.com";
$linkedinlink 	= ($siteInfoArr[4] != "")?$siteInfoArr[4]:"http://www.linkedin.com";
$paypalid 		= ($siteInfoArr[5] != "")?$siteInfoArr[5]:"businessbestchoice@gmail.com";
$adminemail 	= ($siteInfoArr[6] != "")?$siteInfoArr[6]:"ops@idns-technologies.info";
$sitetitle 		= ($siteInfoArr[7] != "")?$siteInfoArr[7]:$_SERVER["SERVER_NAME"];
$sitedescription= ($siteInfoArr[8] != "")?$siteInfoArr[8]:$_SERVER["SERVER_NAME"];
$sitekeywords 	= ($siteInfoArr[9] != "")?$siteInfoArr[9]:$_SERVER["SERVER_NAME"];
