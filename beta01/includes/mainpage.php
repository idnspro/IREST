...
<div class="special-offers-section">
	<div class="container">
		<div class="special-offers-section-head text-center dotted-line">
			<h4>We're in Hundreds Restaurants in top Cities</h4>
		</div>
					...
					<li>
						<div class="offer">
							...
							<div class="offer-text">
								...
								<input type="button" value="See it">
								<span></span>
							</div>
							<div class="clearfix"></div>
						</div>
	...
	<div class="container">
		<div class="contact-section-grids">
			...
			<div class="col-md-3 contact-section-grid wow fadeInRight" data-wow-delay="0.4s">
				...
				<ul>
					<li><i class="fb"></i></li>
					<li class="data"> <a href="<?php echo $facebooklink; ?>" target="_blank"> Facebook </a></li>
				</ul>
				<ul>
					<li><i class="tw"></i></li>
					<li class="data"> <a href="<?php echo $twitterlink; ?>" target="_blank"> Twitter </a></li>
				</ul>
				<ul>
					<li><i class="in"></i></li>
					<li class="data"><a href="<?php echo $linkedinlink; ?>" target="_blank"> Linkedin </a></li>
				</ul>
				<ul>
					<li><i class="yt"></i></li>
					<li class="data"><a href="<?php echo $youtubelink; ?>" target="_blank"> YouTube </a></li>
				</ul>
				<?php /* ?>
				<ul>
					<li><i class="gp"></i></li>
					<li class="data"><a href="<?php echo $gpluslink; ?>">Google Plus</a></li>
				</ul>
				<?php */ ?>
			</div>
