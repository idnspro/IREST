        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th class="col-md-1">Schedule for</th>
            ...
            for($i=0; $i < count($odrListArr); $i++) {
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="orders.php?sec=view&order_id=<?php echo $order_id; ?>" class="btn btn-success">View</a>
                    </td>
                </tr>
            <?php
            }
...
<div class="panel panel-default">
    <div class="panel-heading"><h3>Manage Orders</h3></div>
    <div class="panel-body">
        <p class="text-warning">No order available!</p>
    </div>
</div>
<?php
}
