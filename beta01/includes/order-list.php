    ...
    <div class="panel-body">
        ...
        <div class="cols-md-12">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th class="col-md-1 text-center" align="center">Order ID</th>
                ...
                <tbody>
                    ...
                    for($i=0; $i < count($odrListArr); $i++) {
                        ...
                        <tr>
                            ...
                            <td align="left"><?php echo $delivery_name; ?></td>
                            <td align="left"><?php echo $address; ?></td>
                            <td align="center"><?php echo $schedule_for; ?></td>
                            <td align="left"><?php echo '$'.number_format($final_price, 2); ?></td>
                            <td align="center"><?php echo $status; ?></td>
                            <td align="center">
                                <a href="manager-restaurants-order.php?sec=edit&order_id=<?php echo $order_id; ?>&rest_id=<?php echo $rest_id; ?>&back_url=<?php echo $_GET['back_url']; ?>" class="btn btn-success">Update</a> <a href="manager-restaurants-order.php?sec=view&order_id=<?php echo $order_id; ?>&rest_id=<?php echo $rest_id; ?>&back_url=<?php echo $_GET['back_url']; ?>" class="btn btn-success">View</a>
                            </td>
                        </tr>
                        <?php
                        }
