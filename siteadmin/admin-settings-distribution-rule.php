...
$mainPage = "distribution-rule.php";
$addtitle = "Manage Coupon Rule";
?>
...
<head>
    ...
    <script type="text/javascript" language="javascript">
		function validateSaveProfile(){
			if(document.getElementById("txtRestNameId").value == "") {
				document.getElementById("showErrorRestNameId").innerHTML = "<font style='color:#FF0000;'>Restaurant Name required</font>";
				document.getElementById("txtRestNameId").focus();
				return false;
			}
			if(document.getElementById("txtRestCountryId").value == "") {
				document.getElementById("showErrorRestAddId").innerHTML = "<font style='color:#FF0000;'>Restaurant Address required</font>";
				document.getElementById("txtRestCountryId").focus();
				return false;
			}
			if(document.getElementById("txtRestZipId").value == "") {
				document.getElementById("showErrorRestZipId").innerHTML = "<font style='color:#FF0000;'>Restaurant Zip Code required</font>";
				document.getElementById("txtRestZipId").focus();
				return false;
			}
			document.frmRestProfile.submit();
		}
	</script>
</head>
<body>
