...
Fx.Slide = new Class({
	...
	vertical: function(){
		...
		this.layout = 'height';
		this.offset = this.offset || this.element.offsetHeight;
	},

	horizontal: function(){
		this.margin = 'margin-left';
		this.layout = 'width';
		this.offset = this.offset || this.element.offsetWidth;
	},
...
});///Tips.alias('position', 'setPosition'); //compatability

Tips = Class.refactor(Tips, {
  setPosition: function (event){
    return this.position(event);
  }
});
...
window.addEvent('domready', function(){
  var myTips1 = new Tips($$('.tips'), {
  	maxTitleChars: 50,		// long caption
       	onShow: function(tip){
       		this.tip.setStyles({display: 'block', visibility: 'visible'});
       	},
        className: 'tip'
  });
});
