...
switch($sortby) {
	case 0: $sortField  = "A.state_name"; $orderDir = "ASC"; break;
	default: $sortField = "A.state_name"; $orderDir = "ASC"; break;
}
...
$rsQuery				= $locationObj->fun_getStateArr($strQueryParameter);
$rsQueryCount			= $locationObj->fun_getStateArr($strQueryCountParameter);
        ...
        <tr>
            <td valign="top">
                <div class="floatRight pad-top5 pad-btm5" align="right">
                    <a href="admin-settings.php?sec=location&action=add&show=state&country_id=<?php echo $country_id;?>" class="button-blue" style="text-decoration:none;">Add a new State</a>&nbsp;
                </div>
            </td>
        </tr>
        <tr>
                    ...
                    <table width="98%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="76%" valign="middle">
                             <strong><?php if(isset($pagination['total_rows']) && $pagination['total_rows'] > 1) { echo "Showing ".$pagination['first_row']." to ".$pagination['last_row']." of ".$pagination['total_rows']." states";} else if(isset($pagination['total_rows']) && $pagination['total_rows'] == 1){echo "Showing ".$pagination['first_row']." to ".$pagination['last_row']." of ".$pagination['total_rows']." state";} ?></strong>
                            </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="black12arial">
                       <tr style="background:url(images/glossyback.gif) repeat-x; height:35px;">
                        ...
                        for($i=0; $i < count($listArr); $i++) {
                            $state_id     		= $listArr[$i]['state_id'];
                            $state_name 		= $listArr[$i]['state_name'];
                            $latitude 			= $listArr[$i]['latitude'];
                            $longitude 			= $listArr[$i]['longitude'];
                            $zoom_level 		= $listArr[$i]['zoom_level'];
                        ?>
                            <tr>
                                <td class="pad-top5 pad-rgt5 pad-btm5 pad-lft5" align="center"><a href="admin-settings.php?sec=location&show=state&action=edit&state_id=<?php echo $state_id; ?>" class="blue-link font12" style="text-decoration:none;"><?php echo fill_zero_left($state_id, "0", (6-strlen($state_id)));?></a></td>
                                <td class="pad-top5 pad-rgt5 pad-btm5 pad-lft5" align="left"><a href="admin-settings.php?sec=location&show=city&state_id=<?php echo $state_id; ?>" class="blue-link font12" style="text-decoration:none;"><?php echo $state_name;?></a></td>
                                ...
                                <td class="pad-top5 pad-rgt5 pad-btm5 pad-lft5" align="center"><a href="admin-settings.php?sec=location&show=state&action=edit&state_id=<?php echo $state_id; ?>" class="blue-link font12" style="text-decoration:none;">Edit</a></td>
                            </tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td valign="top">No state available!</td>
	</tr>
</table>
<?php
}
