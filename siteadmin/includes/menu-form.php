...
<form name="frmMenu" id="frmMenu" method="post" action="admin-restaurant-menu.php?sec=edit&menu_id=<?php echo $menu_id;?>&rest_id=<?php echo $rest_id;?>" enctype="multipart/form-data">
