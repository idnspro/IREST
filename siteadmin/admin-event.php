...
<head>
    ...
    <script type="text/javascript" language="javascript" src="includes/js/jquery-1.3.2.js"></script>
    <script type="text/javascript" language="javascript" src="includes/js/ui.core.js"></script>
    <script type="text/javascript" language="javascript" src="includes/js/ui.datepicker.js"></script>    
